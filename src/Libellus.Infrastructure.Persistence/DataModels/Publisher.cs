...
internal class Publisher : BaseStampedModel<PublisherId, GroupId>, ISearchable
{
    ...
    public Publisher(PublisherId id, GroupId groupId, ZonedDateTime createdOnUtc, ZonedDateTime modifiedOnUtc,
