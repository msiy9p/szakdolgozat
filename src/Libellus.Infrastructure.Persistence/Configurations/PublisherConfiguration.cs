...
internal sealed class PublisherConfiguration : BaseConfiguration, IEntityTypeConfiguration<Publisher>
{
    public void Configure(EntityTypeBuilder<Publisher> builder)
    {
        // Table
        builder.ToTable(Rewrite(nameof(Publisher)), SocialSchemaName);

        // Properties/Columns
        builder.Property(x => x.Id)
            .HasColumnName(Rewrite(nameof(Publisher) + nameof(Publisher.Id)))
