...
internal sealed class FormatConfiguration : BaseConfiguration, IEntityTypeConfiguration<Format>
{
    public void Configure(EntityTypeBuilder<Format> builder)
    {
        // Table
        builder.ToTable(Rewrite(nameof(Format)), SocialSchemaName);

        // Properties/Columns
        builder.Property(x => x.Id)
            .HasColumnName(Rewrite(nameof(Format) + nameof(Format.Id)))
