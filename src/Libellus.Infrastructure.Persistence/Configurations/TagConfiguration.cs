...
internal sealed class TagConfiguration : BaseConfiguration, IEntityTypeConfiguration<Tag>
{
    public void Configure(EntityTypeBuilder<Tag> builder)
    {
        // Table
        builder.ToTable(Rewrite(nameof(Tag)), SocialSchemaName);

        // Properties/Columns
        builder.Property(x => x.Id)
            .HasColumnName(Rewrite(nameof(Tag) + nameof(Tag.Id)))
