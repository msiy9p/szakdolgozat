...
internal sealed class LanguageConfiguration : BaseConfiguration, IEntityTypeConfiguration<Language>
{
    public void Configure(EntityTypeBuilder<Language> builder)
    {
        // Table
        builder.ToTable(Rewrite(nameof(Language)), SocialSchemaName);

        // Properties/Columns
        builder.Property(x => x.Id)
            .HasColumnName(Rewrite(nameof(Language) + nameof(Language.Id)))
